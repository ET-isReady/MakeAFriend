...
const registerUser = async (req, res)=>{
   try{
       ...
       //validating a strong password w/ minimum of 6 characters
       if( password.length < 6){
           return res.json({ success:false, message: 'Passwords must be a minimum of 6 characters!'})
       }
...
const bookAppointment = async (req, res)=>{
   try{
       ...
       if(!serviceData.available){
           return res.json({ success:false, message: 'This service is currently unavailable. Check back soon.'})
       }
...
// API to get user appointments list for frontend
